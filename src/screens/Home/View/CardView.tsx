...
interface CardViewProps {
    ...
    onTouch: (item: AllProductResponse) => void
}

const CardView: React.FC<CardViewProps> = ({item, onAddCart, onTouch}) => {
    const screenWidth = Dimensions.get('window').width;
    return(
        <TouchableOpacity onPress={() => onTouch(item)} style={{backgroundColor: 'white', padding: 0, borderRadius: 5, elevation: 10, shadowColor: '#000', shadowOffset: {width: 2, height: 5}, shadowOpacity: 0.2, shadowRadius: 1.41, marginVertical: 15, width: screenWidth}}>
